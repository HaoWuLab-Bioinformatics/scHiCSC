...
def con_ran(arg):
    ...
    # contact_2655, 2655 The first and second columns of the dataset are bin numbers, and the third column is the contact count of two bins
    file_path = "../dataset/contact_2655/%s/cell_%s_%s.txt" % (type, str(cell_id), chr_name)
    ##################################################################
    ...
    r_path = "./Data/after_smooth/Adj_KPCA_2655/%s/cell_%s_%s.txt" % (type, str(cell_id), chr_name)
...
def main():
    ...
    # /Data/after_smooth/Adj_KPCA_2655/GM12878、HAP1、HeLa、K562
    # /Data/after_bin/Adj_KPCA_2655/
    ##################################################################
    ...
    # The first and second columns of contacts_2655,2655 and other data sets are bin ( chromosome fragment ) numbers, and the third column is the contact count of two bins.
    ###################################################################
    ...
    types = {'HeLa': 1757, 'HAP1': 744, 'GM12878': 44, 'K562': 110}
    ...
    out_path1 = './Data/after_bin/Adj_KPCA_2655/cell_dict.npy'
