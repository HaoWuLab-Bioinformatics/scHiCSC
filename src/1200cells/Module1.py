...
def con_ran(arg):
    ...
    r_path = "./Data/after_smooth/Adj_KPCA_1200/%s/cell_%s_%s.txt" % (type, str(cell_id), chr_name)
...
def main():
    ...
    # /Data/after_smooth/Adj_KPCA_1200/GM12878、HAP1、HeLa、K562
    # /Data/after_bin/Adj_KPCA_1200/
    ##################################################################
    ...
    # The first and second columns of contacts_1200,2655 and other data sets are bin ( chromosome fragment ) numbers, and the third column is the contact count of two bins.
    ###################################################################
    ...
    types = {'HeLa': 730, 'HAP1': 316, 'GM12878': 44, 'K562': 110}
    ...
    out_path1 = './Data/after_bin/Adj_KPCA_1200/cell_dict.npy'
