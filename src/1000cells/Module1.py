...
def con_ran(arg):
    ...
    # contact_1000, 2655 The first and second columns of the dataset are bin numbers, and the third column is the contact count of two bins
    file_path = "../dataset/contact_1000/%s/cell_%s_%s.txt" % (type, str(cell_id), chr_name)
    ##################################################################
    ...
    r_path = "./Data/after_smooth/Adj_KPCA_1000/%s/cell_%s_%s.txt" % (type, str(cell_id), chr_name)
...
def main():
    ...
    # /Data/after_smooth/Adj_KPCA_1000/GM12878、HAP1、HeLa、K562
    # /Data/after_bin/Adj_KPCA_1000/
    ##################################################################
    ...
    # The first and second columns of contacts_1000,2655 and other data sets are bin ( chromosome fragment ) numbers, and the third column is the contact count of two bins.
    ###################################################################
    ...
    types = {'HeLa': 600, 'HAP1': 246, 'GM12878': 44, 'K562': 110}
    ...
    out_path1 = './Data/after_bin/Adj_KPCA_1000/cell_dict.npy'
